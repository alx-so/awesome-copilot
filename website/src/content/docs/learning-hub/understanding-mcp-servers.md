...
- *(v1.0.81+)* GitHub Copilot CLI, SDK, IDE, and in-memory clients now support the **MCP 2026-07-28 spec revision**, enabling compatibility with the latest generation of MCP servers
