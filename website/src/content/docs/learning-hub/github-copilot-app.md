...
### Opening the App from the Terminal

*(v1.0.81+)* If you have GitHub Copilot CLI installed, you can open the Copilot app directly from your terminal in the current directory:

```bash
copilot app
```

This launches the GitHub Copilot app focused on the current repository — a quick way to hand off work from the CLI to the app's visual interface without navigating manually.
